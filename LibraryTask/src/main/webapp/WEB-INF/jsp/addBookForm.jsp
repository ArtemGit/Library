...
<%
    ...
    out.print(request.getParameter("baookname"));
    out.print(request.getParameter("bookauthor"));
    out.print(request.getParameter("bookYear"));
    out.print(request.getParameter("bookdescription"));
...
<div class="generic-container"  >
    <div class="panel panel-default">
        ...
        <div class="formcontainer">
            <form method="POST" action="/books/addBook" ng-model="myForm" name="myForm" id="myFile" class="form-horizontal" enctype="multipart/form-data">
                <div class="row">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-md-2 control-lable" for="bcontent">Содержание книги</label>
                        <div class="col-md-7">
